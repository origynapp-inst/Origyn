...
import { Clock, FileText, Music, Video } from 'lucide-react';
...
export const JournalScreen: FC = () => {
  ...
  console.log(
    'Entries with files:',
    journalEntries.filter(entry => entry.fileUrl)
  );
                ...
                {entry.fileUrl && (
                  ...
                  >
                    ...
                    <div className="text-xs text-blue-500 mb-2">
                      Debug: File URL exists = {!!entry.fileUrl}
                    </div>
                    <div className="text-xs text-red-500 mb-2">
                      isAudioFile result:{' '}
                      {isAudioFile(entry.fileUrl).toString()} | Extension:{' '}
                      {entry.fileUrl.split('.').pop()?.toLowerCase()}
                    </div>
                    <button
                    ...
                    {isAudioFile(entry.fileUrl) && (
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-green-500 mb-2">
                          DEBUG: Audio file detected: {entry.fileUrl}
                        </div>
